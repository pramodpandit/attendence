...
class LeadBranches extends StatefulWidget {
  final data;
  const LeadBranches({Key? key,required this.data}) : super(key: key);

  @override
  State<LeadBranches> createState() => _LeadBranchesState();
}

class _LeadBranchesState extends State<LeadBranches> {
  _LeadBranchesState();
  ...
  void initState() {
    ...
    bloc.getSpecificLeadData(widget.data.toString(),"lead_branches");
  }
  @override
        ...
        children: [
          SizedBox(
            ...
            child: FloatingActionButton.extended(
                ...
                onPressed: () async{
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>AddLeadBranch(bloc: bloc,leadId: widget.data,)));
                },
