...
class LeadTechnology extends StatefulWidget {
  final data;
  const LeadTechnology({Key? key,required this.data}) : super(key: key);
  @override
  State<LeadTechnology> createState() => _LeadTechnologyState();
}

class _LeadTechnologyState extends State<LeadTechnology> {
  _LeadTechnologyState();
  late LeadsBloc bloc;
  @override
  void initState() {
    ...
    bloc.getSpecificLeadData(widget.data.toString(),"lead_technology");
  }
  @override
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Flexible(
                              child: Text(
                                "${DateFormat.yMMMd().format(DateTime.parse(data['created_date']))}",
