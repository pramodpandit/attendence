...
import 'leaves_detail_hr.dart';

class LeavesRecordsPagehr extends StatefulWidget {
  const LeavesRecordsPagehr({Key? key}) : super(key: key);

  @override
  State<LeavesRecordsPagehr> createState() => _LeavesRecordsPagehrState();
}

class _LeavesRecordsPagehrState extends State<LeavesRecordsPagehr> {
                                      ...
                                      onTap: (){
                                        ...
                                        Navigator.of(context).push(MaterialPageRoute(
                                          builder: (context) => Provider.value(
                                            value: bloc,
                                            child: LeavesDetailhr(data: leaves[i],responseButton: false,),
                                          ),
                                        ));
                                      },
                                      child: Container(
