...
import 'add_pages/task_add_notes.dart';

class TaskNotes extends StatefulWidget {
  final int id;
  const TaskNotes({Key? key, required this.id}) : super(key: key);

  @override
  State<TaskNotes> createState() => _TaskNotesListState();
}

class _TaskNotesListState extends State<TaskNotes> {
  ...
  void initState() {
    ...
    bloc.fetchTaskDetails(widget.id!,'task_notes');
  }
  @override
