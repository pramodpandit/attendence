    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) {
      ...
      AwesomeNotifications().setListeners(onActionReceivedMethod: (receivedAction) async{
        ...
        if(receivedAction.buttonKeyPressed == "ACCEPT"){
          ...
          Navigator.push(context, MaterialPageRoute(builder: (context) => CallPage(type: message.data['type'],callId: message.data['callId'], prefs:prefs, name: message.data['name'],),));
        }
      },);
      // } else {
